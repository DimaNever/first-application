package com.dmdev.level2.practice.collections.lesson19.map;

import com.dmdev.level2.practice.collections.lesson19.person.Person;
...
//        ListEx<String> strings = Arrays.asList("123", "456", "14", "678");
